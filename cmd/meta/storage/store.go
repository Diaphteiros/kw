...
var StoreCmd = &cobra.Command{
	...
	Short:   "[DEPRECATED] Store the current configuration",
	Long: `Store the current configuration under the given key.
...
Note that the storage is shared between all terminal sessions.`,
	Deprecated: "use 'bookmark save' instead.",
	Run:        bookmark.SaveCmd.Run,
}
