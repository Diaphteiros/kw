## kw kubectl-env powershell

Generate a powershell script that points the KUBECONFIG env var to the kubeconfig for the current kw session
...
```
kw kubectl-env powershell [flags]
```
